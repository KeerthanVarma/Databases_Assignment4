-- ======================================================================
-- Shard 1 Schema (Port 3308)
-- Create all shard_1_* tables for data where user_id % 3 = 1
-- ======================================================================
...
CREATE TABLE IF NOT EXISTS shard_1_students (
    ...
    shard_id INT DEFAULT 1,
    FOREIGN KEY (user_id) REFERENCES shard_1_users(user_id),
...
CREATE TABLE IF NOT EXISTS shard_1_resumes (
    ...
    shard_id INT DEFAULT 1,
    FOREIGN KEY (user_id) REFERENCES shard_1_users(user_id),
    FOREIGN KEY (student_id) REFERENCES shard_1_students(student_id),
    INDEX idx_user_id (user_id),
